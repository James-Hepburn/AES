...
using AES-128. Uses the state representation, AES transformations,
and the key schedule defined in other modules to perform all rounds
of encryption and produce a 16-byte ciphertext.
'''
